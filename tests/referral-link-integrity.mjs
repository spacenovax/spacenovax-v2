...
assert.match(server, /referralLink:\s*telegramReferralLink/, 'primary app referral link is not the official Telegram deep link');
...
console.log(JSON.stringify({ officialBot: true, signedHandoff: true, oneTimeAttribution: true, hardLimit: 1000 }));
