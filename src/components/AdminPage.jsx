...
export default function AdminPage() {
  ...
  const [sponsors, setSponsors] = useState({ enabled: false, maxPartners: 5, placements: ['mining-top', 'global-chat'], banners: [] });
