...
<meta property="og:type" content="website"><meta property="og:site_name" content="SpaceNovaX"><meta property="og:title" content="Join ${inviter}'s SpaceNovaX Fleet"><meta property="og:description" content="Daily mining · Missions · NOVA-X defense · Global community. Join the official fleet."><meta property="og:url" content="${shareUrl}"><meta property="og:image" content="${imageUrl}"><meta property="og:image:alt" content="SpaceNovaX — Explore, Earn, Beyond">
<meta name="twitter:card" content="summary_large_image"><meta name="twitter:title" content="Join ${inviter}'s SpaceNovaX Fleet"><meta name="twitter:description" content="Daily mining · Missions · NOVA-X defense · Global community."><meta name="twitter:image" content="${imageUrl}">
